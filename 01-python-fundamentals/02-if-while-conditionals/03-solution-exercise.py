...
userinput = input("Make a guess between 1 and 100: ")
while type(userinput) != int:
    if userinput.isnumeric():
        userinput = int(userinput)
        break
    else:
        print("Please guess a whole number between 1 and 100")
        userinput = input("Make a guess between 1 and 100: ")   

i = 1
while i <= 10:
    if userinput == rand_int:
        print(f"Good Guess! The number was {rand_int}")
        break
    elif userinput > rand_int:
        print("Too large")
        userinput = input("Make a guess between 1 and 100: ")
        while type(userinput) != int:
            if userinput.isnumeric():
...
if i > 10:
    print(f"Your 10 guesses are up, the answer was {rand_int}")
